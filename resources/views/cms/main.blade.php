    ...
    setColors(color);" :class="{ 'dark': isDark }">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main>
                    <!-- Content header -->
                    <div class="flex items-end justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
                        <h1 class="text-center text-4xl font-semibold ml-5 md:ml-10">
                            {{ $title ?? 'Selamat Datang Admin ' }}</h1>
                    </div>
                    {{-- ISI KONTEN  --}}
                    @yield('content')
                    {{-- END ISI KONTEN --}}
