...
@section('content')
    <div class="m-10 p-5">
        <div class="grid grid-cols-1 gap-3">
            <div class="">
                <form class="max-w-full" enctype="multipart/form-data" action="{{ route('berita.store') }}" method="post">
                    @csrf
                    <x-input field="judul" label="Judul Berita" type="text" placeholder=" "
                        value="{{ old('judul') }}"></x-input>
                    <x-input field="tanggal" label="Tanggal" type="date" placeholder=" "></x-input>
