...
@section('content')
    {{-- main section  --}}
    <div class="bg-white">
        <div class="px-8 py-24 mx-auto text-center md:px-12 lg:px-24 lg:pt-24 text-zinc-500">
            <main class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-28 mt-20">
                <a href="#" target="_blank" rel="noreferrer"
                    class="border rounded-2xl py-1 px-4 text-slate-500 text-sm mb-5 hover:scale-105 transition duration-300 ease-in-out">Always
                    Updated, Always Trusted</a>
                <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">
                    Get Trusted News at Your
                    <span class="relative whitespace-nowrap text-orange-400">
                        ...
                        <span class="relative">Fingertips!</span>
                    </span>
                </h1>
                <p class="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">Berita Published provides the latest and
                    accurate news that can be accessed anytime. From local to international, we pack all the important news
                    in one platform.</p>
                <a class="bg-black rounded-xl text-white font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-black/80"
                    href="/news">Explore news →
                </a>
            </main>
        </div>
    </div>
    ...
    <a href="/news">
        <h1 class="bg-orange-400 rounded-xl text-center w-96 mx-auto text-white font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-black/80"
            href="/news">View
            More news →
        </h1>
    </a>
